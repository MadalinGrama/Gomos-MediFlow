    ...
    <section id="appointment" class="appointment section-bg">
        <div class="container">
            ...
            <form action="{{ route('appointment.store') }}" method="post" role="form" class="php-email-form">
                ...
                <div class="row">
                    <!-- Input pentru telefon și data programării -->
                    <div class="col-md-6 form-group">
                        <input type="tel" class="form-control" name="phone" id="phone" placeholder="Your Phone" required>
                    </div>
                    <div class="col-md-6 form-group mt-3 mt-md-0">
                        <!-- <input type="datetime-local" name="date" class="form-control" id="date" placeholder="Select Date" data-input required>              -->
                        <x-flatpickr id="appointment_date" name="appointment_date" placeholder="Select Date" show-time :time24hr="true" time-format="h:i" alt-format="F j, Y, H:i" max-time="20:30" :first-day-of-week="1" clearable/>
                    </div>
                </div>
